...
const styles = StyleSheet.create({
  ...
  rolePill: {
    ...
    backgroundColor: Colors.infoBg, paddingHorizontal: 12, paddingVertical: 6,
  ...
  editBtn: {
    backgroundColor: Colors.infoBg, paddingHorizontal: 14, paddingVertical: 7,
  ...
  activeBadge: { backgroundColor: Colors.successBg, paddingHorizontal: 10, paddingVertical: 4, borderRadius: Radius.full },
  ...
  eyeIcon: { fontSize: 18 },
  errorCard: {
    marginHorizontal: 14, marginBottom: 4, backgroundColor: Colors.errorBg,
    borderRadius: Radius.sm, padding: 10,
    borderWidth: 1, borderColor: 'rgba(163,45,45,0.18)',
  },
